...
// Destructor
Mesh::~Mesh() { } // Empty as the smart pointers will take care of themselves
...
void Mesh::CreateBuffers(const char* name, unsigned int vertexCount, unsigned int indexCount,
